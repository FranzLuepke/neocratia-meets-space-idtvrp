...
export class NewsComponent implements OnInit {
  news = [
    ...
    },
    {
      ...
      text:
        "A new online platform isn't enough to fix democracy. But we CAN make an innovative tool to allow smart inclusive debate transparent and inclusive decision-making.",
      photo:
